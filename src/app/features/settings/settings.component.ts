...
profileVisibility: STRING_TO_VISIBILITY[this.privacySettings['profileVisibility']],
postVisibility: STRING_TO_VISIBILITY[this.privacySettings['postVisibility']],
friendListVisible: STRING_TO_VISIBILITY[this.privacySettings['friendListVisible']],
searchDiscoverable: STRING_TO_VISIBILITY[this.privacySettings['searchDiscoverable']],
};
...
this.privacySaving.set(false);
const msg =
err?.error?.message ?? 'Không thể cập nhật quyền riêng tư';
this.toast.show(msg, 'error');
},
});
}
