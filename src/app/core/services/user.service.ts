...
import { UserProfile, UserSearchResult, PrivacySettings } from '../models/user.models';
...
return this.http.get<ApiResponse<PrivacySettings>>(
`${API_BASE}/users/me/privacy-settings`,
);
}

updatePrivacySettings(
dto: PrivacySettings,
): Observable<ApiResponse<PrivacySettings>> {
return this.http.put<ApiResponse<PrivacySettings>>(
`${API_BASE}/users/me/privacy-settings`,
dto,
);
}
